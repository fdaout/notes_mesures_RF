...
SPfile X1 1 600 140 -26 -49 0 0 "resistance_2.s1p" 0 "1" 0 "polar" 0 "linear" 0 "short" 0 "none" 0 "block" 0 "SOT23" 0
TLIN Line1 1 510 140 -26 20 0 0 "50 Ω" 1 "d" 1 "0 dB" 0 "26.85" 0 "" 0 "" 0
Eqn Eqn1 1 220 550 0 8 0 0 "fre=400e6=" 1 "d=0.049=" 1 "rho=yvalue(S[1,1],fre)=" 0 "VSWR=(1+abs(rho))/(1-abs(rho))=" 0 "Zu=rtoz(rho)=" 0 "yes" 0
</Components>
<Wires>
